...
def load_config(path=CONFIG_FILE):
    ...
    # [NETWORK]
    net_default_role        = config.get("NETWORK", "default_role",        fallback=None)
    net_default_site        = config.get("NETWORK", "default_site",        fallback=None)
    net_default_device_type = config.get("NETWORK", "default_device_type", fallback=None)
    ...
    return {
        ...
        "net_default_role":        net_default_role.strip() if net_default_role else None,
        "net_default_site":        net_default_site.strip() if net_default_site else None,
        "net_default_device_type": net_default_device_type.strip() if net_default_device_type else None,
    }
...
# --- Интерактив: поведение при исчезнувших VM ---
